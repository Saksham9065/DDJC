...
function ReportPublications() {
  const reports = [
    {
      id: 1,
      title: "Human Rights Report",
      description:
        "Research and documentation highlighting human rights challenges, legal interventions, and recommendations for policy improvement.",
      file: "/documents/research-report.pdf",
    },
    {
      id: 2,
      title: "Legal Aid Impact Report",
      description:
        "An overview of DDJC's legal aid initiatives, case outcomes, awareness programmes, and community outreach efforts.",
    ...
    },
    {
      ...
      title: "Policy Brief",
      description:
        "A concise report presenting evidence-based recommendations to strengthen constitutional rights and access to justice.",
      ...
      >
        <motion.div variants={itemVariants} className="text-center flex flex-col items-center mb-16">
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed text-center max-w-xl">
            Explore DDJC's reports and research publications that support legal awareness, policy advocacy, and social justice.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reports.map((item) => (
            <motion.div 
              ...
              className="bg-white border border-gray-100 rounded-3xl p-7 hover:shadow-xl transition-all duration-300"
...
export default ReportPublications;
