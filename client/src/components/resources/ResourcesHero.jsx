    ...
    <section className="relative min-h-[60vh] md:min-h-[65vh] flex items-center justify-center overflow-hidden bg-[#0A2540] py-16 md:py-20">
      ...
      <div className="container mx-auto px-6 relative z-10 flex justify-center">
        ...
        >
          ...
          >
            Explore DDJC's collection of publications, legal guides, reports, and downloadable resources designed to promote constitutional awareness, legal literacy, and equal access to justice.
          </motion.p>
          <motion.div 
            variants={fadeInUp}
          ...
          >
            ...
            <a
              href="/documents/legal-guide.pdf"
              download
