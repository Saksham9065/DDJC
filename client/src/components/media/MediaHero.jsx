    ...
    <section className="relative min-h-[60vh] md:min-h-[65vh] flex items-center justify-center overflow-hidden bg-[#0A2540] py-16 md:py-20">
      ...
      <div className="container mx-auto px-6 relative z-10 flex justify-center">
        ...
        >
          ...
          >
            Explore DDJC's media gallery, community events, awareness campaigns, legal initiatives, and stories that highlight our commitment to justice, equality, and human dignity.
          </motion.p>
          <motion.div 
            variants={fadeInUp}
